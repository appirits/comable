...
ActiveRecord::Schema.define(version: 20140128030224) do
  ...
  create_table "comable_cart_items", force: true do |t|
    ...
    t.integer "comable_product_id",              null: false
    t.integer "quantity",            default: 1, null: false
  end

  add_index "comable_cart_items", ["comable_customer_id", "comable_product_id"], name: "comable_cart_items_by_customer", unique: true, using: :btree
